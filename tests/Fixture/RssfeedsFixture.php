 ...
 *
 */
class RssfeedsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'feedurl' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'siteurl' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'feedurl' => 'Lorem ipsum dolor sit amet',
            'siteurl' => 'Lorem ipsum dolor sit amet',
            'date' => '2017-12-13 12:38:39',
